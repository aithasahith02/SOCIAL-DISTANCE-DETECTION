...
Original file is located at
    https://colab.research.google.com/drive/1kDBM0I7XCy2HIxd0DnEljQfotCJBaiiv
...
args = vars(ap.parse_args(["--input","/content/drive/MyDrive/yolo-coco/christmas.mp4","--output","output.avi","--display","1"]))
